  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 pb-32 space-y-12">
        {savedOk && <div className="p-5 bg-green-50 border-2 border-green-100 rounded-[2rem] text-green-700 font-black text-[10px] uppercase tracking-widest flex items-center gap-3 animate-bounce">✓ Changes Synchronized</div>}

        {/* 🏪 MARKET IDENTITY SECTION */}
        <section className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-gray-100 border border-gray-100">
           <h2 className="text-lg font-black mb-10 flex items-center gap-3">
              <span className="w-10 h-10 rounded-xl bg-indigo-50 flex items-center justify-center text-xl">🏪</span>
              Market Identity
           </h2>
        ...
        {/* 🚗 LOGISTICS ARCHITECTURE SECTION */}
        <section className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-gray-100 border border-gray-100">
           <h2 className="text-lg font-black mb-10 flex items-center gap-3">
        ...
        <section className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-gray-100 border border-gray-100">
           <div className="flex justify-between items-start mb-10">
              <h2 className="text-lg font-black flex items-center gap-3">
                 <span className="w-10 h-10 rounded-xl bg-indigo-50 flex items-center justify-center text-xl">⚖️</span>
        ...
        <section className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-gray-100 border border-gray-100">
           <h2 className="text-lg font-black mb-10 flex items-center gap-3">
              <span className="w-10 h-10 rounded-xl bg-red-50 flex items-center justify-center text-xl">🛡️</span>
        ...
        <section className="p-10 bg-indigo-600 rounded-[3rem] text-white relative overflow-hidden">
